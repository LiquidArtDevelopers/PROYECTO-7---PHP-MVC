<footer>
        ...
        <div class="cajaInfo">
            ...
            <div class="rrss">
                <a href="" title="Facebook de la [empresa]" target="_blank">
                    <img src="<?=$_ENV['RUTA']?>/assets/img/system/logo-facebook.svg" alt="Facebook de la [empresa]" title="Facebook de la [empresa]" width="30" height="30">
                </a>
                ...
                <a href="" title="Instagram de nuestra [empresa]" target="_blank">
                    <img src="<?=$_ENV['RUTA']?>/assets/img/system/logo-instagram.svg" alt="Instagram de nuestra [empresa]" title="Instagram de nuestra [empresa]" width="30" height="30">
                </a>

                <a href="https://www.youtube.com/@LiquidArtDevelopers" title="YouTube de nuestra [empresa]" target="_blank">
                    <img src="<?=$_ENV['RUTA']?>/assets/img/system/logo-youtube.svg" alt="YouTube de nuestra [empresa]" title="YouTube de nuestra [empresa]" width="30" height="30">
                </a>
            </div>
        </div>
    ...
    <div>
        ...
        <div>
            ...
            <div id="zonaTerminos">
                <a href="<?=$_ENV['RUTA']?>/eu/legezko-terminoak#legalZona">Aviso legal</a>
                <a href="<?=$_ENV['RUTA']?>/eu/legezko-terminoak#cookiesZona">Gestión de cookies</a>
                <a href="<?=$_ENV['RUTA']?>/eu/legezko-terminoak#privacidadZona">Política de privacidad</a>
            </div>
